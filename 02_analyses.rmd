...
stargazer(m1_re_wb_low_inc, type = "text")
ranef(m1_re_wb_low_inc)
...
X_prime_X_b <- as.matrix(vcov(m4_re_wb)) / summary(m4_re_wb)$sigma^2
...
# First add draws of 1/2*sigma2_tilde to each column
X_beta_sigma_tilde_b_dem <- apply(X_beta_b_econ, 2, function(x) x + 1/2*sigma2_tilde_b)

# Transform
E_Y_c_b_econ <- exp(X_beta_sigma_tilde_b_dem)
